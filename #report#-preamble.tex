...
\usepackage{datetime2}
  ...
  \usepackage{listingsutf8} % extension in case there are umlaute
  ...
  \usepackage[backend=biber,style=vancouver, maxbibnames=6, minbibnames=6]{biblatex} %install biblatex-vancouver in /usr/share/texmf/texconfig/, then run /usr/share/texmf/texconfig/update force
